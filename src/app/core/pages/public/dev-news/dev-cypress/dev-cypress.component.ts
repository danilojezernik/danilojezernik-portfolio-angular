...
@Component({
  selector: 'app-dev-cypress',
  standalone: true,
  imports: [CommonModule, HeroTitleComponent, LoadingComponent, ShorteningTextPipe, TranslateModule],
  templateUrl: './dev-cypress.component.html'
})
export class DevCypressComponent {
  ...
  cypressDev$: Observable<DevToArticle[]> = this._devService.getArticlesDevCypress().pipe(
