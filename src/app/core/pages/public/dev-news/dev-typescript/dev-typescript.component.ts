...
@Component({
  selector: 'app-dev-typescript',
  standalone: true,
  imports: [CommonModule, HeroTitleComponent, LoadingComponent, TranslateModule, ShorteningTextPipe],
  templateUrl: './dev-typescript.component.html'
})
export class DevTypescriptComponent {
  ...
  typescriptDev$: Observable<DevToArticle[]> = this._devService.getArticlesDevTypeScript().pipe(
