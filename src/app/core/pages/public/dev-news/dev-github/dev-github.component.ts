...
@Component({
  selector: 'app-dev-github',
  standalone: true,
  imports: [CommonModule, HeroTitleComponent, LoadingComponent, ShorteningTextPipe, TranslateModule],
  templateUrl: './dev-github.component.html'
})
export class DevGithubComponent {
  ...
  githubDev$: Observable<DevToArticle[]> = this._devService.getArticlesDevGitHub().pipe(
