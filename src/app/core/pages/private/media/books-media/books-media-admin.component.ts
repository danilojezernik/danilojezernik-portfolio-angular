...
export class BooksMediaAdminComponent implements OnInit {
  ...
  protected _myBooksGalleryService = inject(BookService);
  ...
  getAllImages(): void {
    ...
    this._myBooksGalleryService.getAllBookImages().pipe(
      catchError(error => {
  ...
  upload(): void {
    if (this.selectedFile) {
      ...
      this._myBooksGalleryService.uploadBookImage(this.selectedFile).pipe(
        catchError(error => {
  ...
  deleteImage(filename: string): void {
    ...
    if (yes) {
      this._myBooksGalleryService.deleteBookImageByName(filename).pipe(
        catchError(error => {
          // Capture and display error message
          this.error = error.message;
          // Return null to handle errors gracefully
