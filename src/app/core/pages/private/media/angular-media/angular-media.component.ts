...
export class AngularMediaComponent implements OnInit {
  ...
  getAllImages(): void {
    ...
    this._angularService.getAllAngularImages().pipe(
      catchError(error => {
  ...
  upload(): void {
    if (this.selectedFile) {
      ...
      this._angularService.uploadAngularImage(this.selectedFile).pipe(
        catchError(error => {
  ...
  deleteImage(filename: string): void {
    ...
    if (yes) {
      this._angularService.deleteAngularImageByName(filename).pipe(
        catchError(error => {
          // Capture and display error message
          this.error = error.message;
          // Return null to handle errors gracefully
